...
{
    #region Both hands pull and push
    ...
    #region Right hand pull and push
    ...
    #region Left hand pull and push
    public class PullAndPush6 : IRelativeGestureSegment
    {
        /// <summary>
        /// Checks the gesture.
        /// </summary>
        ...
        public GesturePartResult CheckGesture(Skeleton skeleton)
        {
            if (Math.Abs(skeleton.Joints[JointType.HandRight].Position.X - skeleton.Joints[JointType.ShoulderRight].Position.X) < 0.15 &&
                Math.Abs(skeleton.Joints[JointType.HandRight].Position.Z - skeleton.Joints[JointType.ShoulderRight].Position.Z) < 0.15 &&
                ...
                )
            {
                if (skeleton.Joints[JointType.HandLeft].Position.X > skeleton.Joints[JointType.ElbowLeft].Position.X &&
                    skeleton.Joints[JointType.Spine].Position.Y < skeleton.Joints[JointType.HandLeft].Position.Z)
                {
                    if (skeleton.Joints[JointType.Head].Position.Z - skeleton.Joints[JointType.HandLeft].Position.Z > 0.4)
                    {
                        // Debug.WriteLine("GesturePart 0 - left hand left of left Shoulder - PASS");
                        return GesturePartResult.Succeed;
                    }
    ...
    public class PullAndPush7 : IRelativeGestureSegment
    {
        /// <summary>
        /// Checks the gesture.
        /// </summary>
        ...
        {
            if (Math.Abs(skeleton.Joints[JointType.HandRight].Position.X - skeleton.Joints[JointType.ShoulderRight].Position.X) < 0.15 &&
                Math.Abs(skeleton.Joints[JointType.HandRight].Position.Z - skeleton.Joints[JointType.HandRight].Position.Z) < 0.15 &&
                skeleton.Joints[JointType.HandRight].Position.Y < skeleton.Joints[JointType.HipRight].Position.Y
                ...
                )
            {
                    ...
                    skeleton.Joints[JointType.Spine].Position.Y < skeleton.Joints[JointType.HandLeft].Position.Z)
                {
                    if (skeleton.Joints[JointType.HandLeft].Position.Y > skeleton.Joints[JointType.HipCenter].Position.Y &&
                        skeleton.Joints[JointType.Head].Position.Z - skeleton.Joints[JointType.HandLeft].Position.Z < 0.2 &&
                        skeleton.Joints[JointType.HandLeft].Position.X <= skeleton.Joints[JointType.HipCenter].Position.X + 0.05)
                    {
                        // Debug.WriteLine("GesturePart 0 - left hand left of left Shoulder - PASS");
                        return GesturePartResult.Succeed;
                    }
    ...
    public class PullAndPush8 : IRelativeGestureSegment
    {
        /// <summary>
        /// Checks the gesture.
        /// </summary>
        ...
        public GesturePartResult CheckGesture(Skeleton skeleton)
        {
            if (Math.Abs(skeleton.Joints[JointType.HandRight].Position.X - skeleton.Joints[JointType.ShoulderRight].Position.X) < 0.15 &&
                Math.Abs(skeleton.Joints[JointType.HandRight].Position.Z - skeleton.Joints[JointType.ShoulderRight].Position.Z) < 0.15 &&
                skeleton.Joints[JointType.HandRight].Position.Y < skeleton.Joints[JointType.HipLeft].Position.Y
                )
            {
                if (
                skeleton.Joints[JointType.HandLeft].Position.Z < skeleton.Joints[JointType.ElbowLeft].Position.Z - 0.1 &&
                skeleton.Joints[JointType.HandLeft].Position.X > skeleton.Joints[JointType.ElbowLeft].Position.X - 0.1 &&
                    skeleton.Joints[JointType.Spine].Position.Y < skeleton.Joints[JointType.HandLeft].Position.Z)
                {
                    if (skeleton.Joints[JointType.HandLeft].Position.Y > skeleton.Joints[JointType.HipCenter].Position.Y &&
                        skeleton.Joints[JointType.Head].Position.Z - skeleton.Joints[JointType.HandLeft].Position.Z < 0.25 &&
                        skeleton.Joints[JointType.HandLeft].Position.X <= skeleton.Joints[JointType.HipCenter].Position.X - 0.05)
                    {
                        // Debug.WriteLine("GesturePart 0 - left hand left of left Shoulder - PASS");
                        return GesturePartResult.Succeed;
