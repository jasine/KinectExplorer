1.引用了WPFSoundVisualizationLibrary http://wpfsvl.codeplex.com/ 提供频谱显示
2.引用了"豆瓣电台" http://doubanfm.codeplex.com/ 中对声音播放的操作项目Douban.Bass(引用了Bass引擎)
3.引用了Do Anything With ID3 http://www.codeproject.com/Articles/17890/Do-Anything-With-ID3 读取mp3文件的ID3资料
